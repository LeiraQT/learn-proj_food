...
function closeModal(modalSelector) {
  ...
  // modal.classList.toggle('show');
  document.body.style.overflow = ''; //Если оставить пустым, то браузер вернет по дефолту
}
...
function timer(id, deadline) {
  function getTimeRemaning(endtime) {
    ...
    const t = Date.parse(endtime) - Date.parse(new Date()); //Получаем кол-во милисекунд
  ...
  function setClock(selector, endtime) {
    ...
    updateClock(); //Функция инициализации
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2024-09-01');
